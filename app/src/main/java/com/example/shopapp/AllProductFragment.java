...
public class AllProductFragment extends Fragment {
    ...
    String names[] = {"Timeless Elegance", "Intricate Filigree Gold", "Timeless Elegance", "Geometric Gold Bracelet", "Gold", "Daimond", "Ganpati", "Gold"};
    String type[] = {"Gold", "Chain", "Necklace Gold", "Pendant", "Necklace", "Ring", "Pandel", "Earings"};
    ...
    HomeFragment categoriesFragment;
